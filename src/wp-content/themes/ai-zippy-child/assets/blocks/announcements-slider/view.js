...
"use strict";
/*!**************************************************************************************!*\
  !*** ./src/wp-content/themes/ai-zippy-child/src/blocks/announcements-slider/view.js ***!
  \**************************************************************************************/
...
function syncSlideMinHeight($slider) {
  let $cards = $slider.find(".slick-slide:not(.slick-cloned) .az-child-announcement__slide");
  ...
  if (maxHeight > 0) {
    $slider.find(".az-child-announcement__slide").css("min-height", `${Math.ceil(maxHeight)}px`);
  }
}
function initAnnouncementSliders() {
  jquery__WEBPACK_IMPORTED_MODULE_0__(".js-az-child-announcement-slider").each((_, element) => {
